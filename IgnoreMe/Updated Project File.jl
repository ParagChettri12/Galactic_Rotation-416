...
begin
	md"""
	**Adjust Average Velocity:** $(@bind scaler Slider(100:10:300, show_value=true, default=200))
	"""
end
...
begin
	md"""
	**Adjust X-Axis Scale (View Window)  
	Max R (kpc):** $(@bind x_max Slider(0:1:50; default=25, show_value=true))
	"""
end
...
manifest_format = "2.0"
project_hash = "6540db420e231f5a5541f649a3e7fc77facb0282"
